...
let originalAmount = parseFloat(document.getElementById("payment_amount").dataset.originalAmount);
...
function updatePaymentAmount() {
    document.getElementById("payment_amount").innerHTML = `<strong>Total: $${currentAmount.toFixed(2)}</strong>`;
    document.getElementById("total_payment_amount").value = currentAmount.toFixed(2);
}
